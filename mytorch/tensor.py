...
class Tensor:
    ...
    def __setitem__(self, idcs, other):
        ...
        self._data[idcs] = ensure_tensor(other).data
    ...
    def backward(self, grad=None, visited=None):
        ...
        for dependency in self.depends_on:
            ...
            dependency.tensor.backward(Tensor(backward_grad), visited)

    def reshape(self, new_shape):
        reshaped_data = self.data.reshape(new_shape)
        return Tensor(reshaped_data, requires_grad=self.requires_grad, depends_on=self.depends_on)
